...
// NEW IMPORTS
const Tag = dynamic(() => import("@/sections/Tag"));
const Toran = dynamic(() => import("@/sections/Toran"));
...
const LAYERS = [
  ...
  { id: "resin", x: 0 },
  { id: "scrapbook", x: 0 },
  { id: "tag", x: 0 }, // Added Tag
  { id: "toran", x: 0 }, // Added Toran
] as const;
...
export default function Home() {
  ...
  const renderContent = (id: string) => {
    ...
    switch (id) {
      ...
      // NEW CASES
      case "tag":
        return <Tag onBack={() => handleNavigate("categories")} />;
      case "toran":
        return <Toran onBack={() => handleNavigate("categories")} />;
      default:
        return null;
    }
  };
