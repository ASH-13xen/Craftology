...
// --- INTERFACES ---
export type ResinItem = CoinItem;
...
export default function Resin({ onBack, data: serverData }: ResinProps) {
  // --- STATE ---
  ...
  const formattedData: ResinItem[] = useMemo(() => {
    ...
    return serverData.map((item: any) => ({
      ...
      image: item.image || "",
      title: item.title || "Untitled Resin Art",
      price: item.price || 0,
    }));
  }, [serverData]);
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 py-12 min-h-full flex flex-col pt-36 md:pt-24 relative z-10">
        ...
        <div className="text-center mb-8 md:mb-16 space-y-3 md:space-y-4">
          ...
          <p className="opacity-80 max-w-lg mx-auto text-sm md:text-lg leading-relaxed font-light text-[#371E10]">
            Preserving nature in time. Coasters, trays, and bookmarks made with
            real flowers, clarity, and intent.
          </p>
        </div>
